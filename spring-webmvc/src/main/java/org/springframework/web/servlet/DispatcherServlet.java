...
public class DispatcherServlet extends FrameworkServlet {
	...
	private void initHandlerMappings(ApplicationContext context) {
		...
		if (this.handlerMappings == null) {
			// TODO web容器启动后，初始化HandlerMapping方法，通过该入口将RequestMappingHandlerMapping的
			//  父父类AbstractHandlerMethodMapping就继承了 InitializingBean 接口，在spring初始化bean的时候
			//	通过该方式，处理url的映射关系
	...
	protected HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
		if (this.handlerMappings != null) {
			// TODO 获取所有的HandlerMapping,根据请求获取适合当前请求的映射处理器
			for (HandlerMapping mapping : this.handlerMappings) {
				// TODO 根据请求获取HandlerMapping,再获取对应的Handler处理器，并包装成HandlerExecutionChain执行链
